...
public:
    ...
    BaseController()
      {
        // Topics to publish
        md49_encoders_pub = n.advertise<md49_base_controller::md49_encoders>("md49_encoders",10);
        md49_data_pub = n.advertise<md49_base_controller::md49_data>("md49_data",10);
        // Topic to subscribe
...
private:
    ...
    md49_base_controller::md49_data md49_data;                                                           /**<  topic /md49_data */
    md49_base_controller::md49_encoders md49_encoders;                                                   /**<  topic /md49_encoders */
